...
from rsl_rl.modules import ActorCritic, ActorCriticRecurrent, ActorCriticMultiLeakyESN, EmpiricalNormalization
...
class OnPolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        actor_critic: ActorCritic | ActorCriticRecurrent | ActorCriticMultiLeakyESN = actor_critic_class(
