...
from legged_env_Z import LeggedEnvZ
...
def get_cfgs():
    env_cfg = {
        ...
        "default_joint_angles": {  # [rad]
            "FR_hip_joint": 0.0, # -0.1, # 0.0,
            "FL_hip_joint": 0.0, # 0.1, # 0.0,
            "RR_hip_joint": 0.0, # -0.1, # 0.0,
            "RL_hip_joint": 0.0, # 0.1, # 0.0,

            "FR_thigh_joint": 0.8, # 1.0,
            "FL_thigh_joint": 0.8, # 1.0,
            "RR_thigh_joint": 1.0, # 0.8, # 1.0,
            "RL_thigh_joint": 1.0, # 0.8, # 1.0,
        ...
        'penalized_contact_link_names': ['base', 'thigh', 'cover'],
        'calf_link_name': ['calf'],
        'feet_link_name': ['foot'],
        'hip_link_name': ['hip'],
    ...
    reward_cfg = {
        "tracking_min_sigma": 0.01,
        "tracking_max_sigma": 0.1, # 0.25,
        "base_height_target": 0.36,
        "relative_base_height_target": 0.36, # 0.40,
        "step_period": 4.0, #1.0, #0.8
        "step_offset": 0.5, #0.5
        "front_feet_relative_height": 0.1, # 0.15,
        "rear_feet_relative_height": 0.1, # 0.15,
        "clearance_start": 0.05,
        "max_reward_height": 0.2,
...
def train_main(
    cfg_patches=None,
    default_exp_name: str = "Z_walking",
):
    ...
    parser.add_argument("--wandb_username", type=str, default="y_fukuda-institution-of-engineering-and-technology")
