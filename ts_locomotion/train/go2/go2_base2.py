...
from legged_env2 import LeggedEnv2
...
def get_cfgs():
    env_cfg = {
        ...
        "angle_termination_duration": 3.0, # 5.0, #seconds
        # base pose
    ...
    obs_cfg = {
        ...
        "privileged_obs_components": [
            ...
            "cos_phase",           # 4
            # "collision"            # 4
            "forces_rate_xy_feet", # 4
            "forces_rate_xy_calf", # 4
        ],
        "mirror_func": {
            ...
            "forces_rate_xy_feet": "mirror_go_foot",
            "forces_rate_xy_calf": "mirror_go_foot",
        },
        "obs_scales": {
            "base_lin_vel": 2.0,
            "base_ang_vel": 0.25,
