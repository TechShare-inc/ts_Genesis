...
class Go2Env:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False):
        ...
        self.commands_scale = torch.tensor(
            [self.obs_scales["lin_vel"], self.obs_scales["lin_vel"], self.obs_scales["ang_vel"], self.obs_scales["base_pitch"]],
            device=gs.device,
            dtype=gs.tc_float,
        )
    ...
    def _resample_commands(self, envs_idx):
        ...
        self.commands[envs_idx, 3] = gs_rand_float(*self.command_cfg["base_pitch_range"], (len(envs_idx),), gs.device)
